  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <link rel="icon" href="./images/logo-16.png" type="image/png" sizes="16x16" />
        <link rel="icon" href="./images/logo-32.png" type="image/png" sizes="32x32" />
        <link rel="icon" href="./images/logo-64.png" type="image/png" sizes="64x64" />
        ...
        <div class="home">
            ...
            <div class="top-bar">
              <div class="logo-circle">
                ...
                <div class="navigation">
                  <p class="nav-text"><span class="text-black">Home</span></p>
                  ...
                  <p class="nav-text"><span class="text-black">Reviews</span></p>
                  <p class="nav-text"><span class="text-black">Contacts</span></p>
                  <div class="search">
          ...
          <div class="news-frame">
            ...
            <div class="button">
              ...
              <div class="primary">
                <p class="text-30"><span class="text-black">Login</span></p>
              </div>
            </div>
          ...
          <div class="footer-3">
            <div class="sub-footer">
              ...
              <p class="text-32"><span class="text-black">About us</span></p>
              <p class="text-32"><span class="text-black">Contacts</span></p>
            </div>
          </div>
        </div>
        </div>
